...
const UserManagement: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Modal isOpen={showModal} onClose={handleCloseModal} className="max-w-[500px] m-4">
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            <div className="px-2">
              <div className="grid grid-cols-1 gap-y-5">
                <div>
                  <label className="block mb-1 font-medium text-gray-700">UserID</label>
                  <input
                    name="userid"
                    type="text"
                    placeholder="UserID"
            ...
            <div className="flex items-center gap-3 px-2 mt-6 justify-end">
              ...
              <Button size="sm" type="submit" className="bg-brand-500 text-white">
                Đăng ký
              </Button>
            </div>
          </form>
