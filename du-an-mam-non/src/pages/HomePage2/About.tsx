    ...
    <section className="w-full  mx-auto py-20 px-6 sm:px-8 lg:px-12 grid grid-cols-1 lg:grid-cols-3 gap-12 items-center font-sans">
      ...
      <div className="lg:col-span-1 flex flex-col items-center lg:items-start gap-6">
        <div className="w-full text-center lg:text-left">
          <div className="flex items-center gap-2 justify-center lg:justify-start mb-2">
            ...
            <span className="uppercase font-semibold text-purple-600 tracking-wide">
              Giới thiệu
            </span>
          </div>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#7F55B1] leading-snug">
            Trường Mầm Non <span className="text-pink-600">KidsMona</span> – Nơi
            Bé Lớn Lên Mỗi Ngày
          </h2>
        </div>
      ...
      <div className="lg:col-span-1 flex flex-col gap-6">
        <p className="text-gray-700 text-base md:text-lg leading-relaxed">
          KidsMona là môi trường giáo dục hiện đại, an toàn và đầy cảm hứng dành
          cho các bé từ 2-6 tuổi. Chúng tôi chú trọng phát triển toàn diện về
          trí tuệ, thể chất, cảm xúc và kỹ năng sống, đồng hành cùng phụ huynh
          để ươm mầm những tài năng nhí.
        </p>
