        ...
        <div className="text-center">
          ...
          >
            <p className="mb-4">
              ...
              <span className="font-semibold text-[#6c2bd9]">KidsMona</span> là
              những người thầy, cô tận tâm, giàu kinh nghiệm và luôn đặt tình
              yêu thương trẻ em lên hàng đầu.
            </p>
            <p>
              Với phương pháp giáo dục hiện đại và môi trường học tập thân
              thiện, chúng tôi cam kết mang đến cho các bé những trải nghiệm học
              tập tuyệt vời nhất.
            </p>
          </div>
