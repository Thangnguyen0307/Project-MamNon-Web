...
const Filter: React.FC<ModalProps> = ({ children, setQuery, search }) => {
  const debouncedSetQuery = debounce((key: string, value: string) => {
    setQuery?.(key, value);
  }, 500);
        ...
        <div className="flex max-sm:flex-col gap-3 ">
          {search && (
            <div className="relative ">
              ...
              <input
                type="text"
                onChange={(e) => debouncedSetQuery("keyword", e.target.value)}
